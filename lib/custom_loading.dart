...
class _CustomLoadingState extends State<CustomLoading>
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      ...
      // icon
      Visibility(visible: widget.type == 4, child: _buildLoadingFive()),

      // normal
      Visibility(visible: widget.type == 5, child: _buildLoadingSix()),
    ]);
  }
  ...
  Widget _buildLoadingFour() {
    return Stack(alignment: Alignment.center, children: [
      RotationTransition(
        ...
        turns: _controller,
        child: Image.asset(
          'assets/loading/20211101174606.png',
          height: 110,
          width: 110,
        ),
      ),
      Image.asset(
        'assets/loading/20211101181404.png',
        height: 60,
        width: 60,
      ),
    ]);
  ...
  Widget _buildLoadingFive() {
    return Stack(alignment: Alignment.center, children: [
      Image.asset(
        'assets/loading/20211101162946.png',
        height: 50,
        width: 50,
      ),
      RotationTransition(
        ...
        turns: _controller,
        child: Image.asset(
          'assets/loading/20211101173708.png',
          height: 80,
          width: 80,
        ),
      ),
      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          RotationTransition(
            ...
            turns: _controller,
            child: Image.asset(
              'assets/loading/20211101163010.png',
              height: 50,
              width: 50,
            ),
          ),
